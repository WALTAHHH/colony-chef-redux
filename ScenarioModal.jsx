  ...
  return (
    <div style={modalOverlayStyles}>
      <div style={modalContentStyles}>
        ...
        <h2 style={titleStyles}>{activeScenario.title}</h2>
        ...
        {!activeScenario.resolved ? (
          <div>
            {activeScenario.choices.map((choice, index) => (
              <button
                ...
                onClick={() => chooseScenarioOption(index)}
                onMouseOver={(e) => {
          ...
          <div>
            <div style={outcomeStyles}>
              <p><strong>Outcome:</strong> {activeScenario.outcomeDescription}</p>
            </div>
            <button
